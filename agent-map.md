...
For repository structure, entry points, commands, and module-specific conventions, read:
- docs/agent-map.md

Do not replace this root AGENTS.md with generated project-map content. This file owns agent behavior; the project map is supporting context.